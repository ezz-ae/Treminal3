...
export default {
  ...
  theme: {
    container: {
      ...
      padding: "2rem",
      screens: {
        "2xl": "1600px", // Increased width for wider pages
      },
    },
    extend: {
      fontSize: {
        xs: ['0.75rem', { lineHeight: '1rem' }],
        sm: ['0.8125rem', { lineHeight: '1.25rem' }], // Slightly smaller
        base: ['0.875rem', { lineHeight: '1.5rem' }], // Standard text size, slightly smaller
