  ...
  return (
    <div className="container mx-auto py-12 px-4">
        <header className="mb-12 text-center">
            <LifeBuoy className="w-12 h-12 mx-auto text-primary mb-4" />
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
             <Card className="bg-card/50 hover:border-primary/50 transition-colors">
                 <Link href="/dashboard/docs">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-3 text-xl"><BookOpen className="text-primary"/> Documentation</CardTitle>
                        <CardDescription>
             ...
             <Card className="bg-card/50 hover:border-primary/50 transition-colors">
                <a href="mailto:support@terminal3.dev">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-3 text-xl"><Mail className="text-primary"/> Email Support</CardTitle>
                        <CardDescription>
