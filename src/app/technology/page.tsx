  ...
  return (
    <div className="container mx-auto py-12 px-4">
        <header className="mb-12 text-center">
            ...
            <h1 className="text-4xl font-bold font-headline">The AI That Powers Terminal3</h1>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center max-w-6xl mx-auto mb-16">
            <div className="bg-card/50 p-6 rounded-lg border">
                ...
                <h3 className="text-xl font-bold font-headline">Security & Reliability</h3>
            ...
            <div className="bg-card/50 p-6 rounded-lg border">
                ...
                <h3 className="text-xl font-bold font-headline">Speed & Efficiency</h3>
                <p className="text-muted-foreground mt-2 text-sm">
             ...
             <div className="bg-card/50 p-6 rounded-lg border">
                ...
                <h3 className="text-xl font-bold font-headline">True Agency</h3>
                <p className="text-muted-foreground mt-2 text-sm">
        ...
        <div className="text-center">
            <h2 className="text-2xl font-bold font-headline">A Google AI Partnership</h2>
