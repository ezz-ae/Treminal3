...
export default function TransactionsPage() {
    ...
    async function onSubmit(data: z.infer<typeof FormSchema>) {
        ...
        addLine({ type: 'status', text: 'Generating transaction...' });
        ...
        try {
            ...
            addLine({ type: 'output', text: 'Error: Could not generate transaction.' });
            setIsLoading(false);
            form.reset();
        }
    }
    ...
    <>
       <div className="sr-only">
        ...
        <p className="text-muted-foreground">
          Describe the transaction you want to execute, and our AI will generate a plan for you.
        </p>
      </div>
