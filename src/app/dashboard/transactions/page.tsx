  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Describe the transaction you want to execute.</p>
      </div>
      ...
      {result && (
        <Card className="max-w-2xl">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <h4 className="font-semibold mb-2">Target Contract</h4>
               <div className="flex flex-wrap gap-2">
             ...
             <Button className="mt-4">Execute Transaction</Button>
          </CardContent>
        </Card>
      )}
    </div>
