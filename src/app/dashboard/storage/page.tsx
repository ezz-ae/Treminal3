...
const FormSchema = z.object({
  description: z.string().min(10, {
    message: 'File description must be at least 10 characters.',
  }),
});
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Describe the file you want to upload to decentralized storage.</p>
      </div>
      ...
      {result && (
        <Card className="max-w-2xl">
          ...
          <CardContent className="space-y-4">
            <div>
              <h4 className="font-semibold mb-2">Storage Network</h4>
