...
const initialLinesDef: DisplayLine[] = [
    ...
    { id: 'guidance-2', type: 'guidance', text: "Describe the file you want to upload and I'll recommend the right tools." },
];
...
export default function StoragePage() {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        addLine({ type: 'status', text: 'Analyzing storage needs...' });
    ...
    <>
       <div className="sr-only">
        ...
        <p className="text-muted-foreground">
          Describe the file you want to upload, and our AI agent will recommend the best tools for you.
        </p>
      </div>
