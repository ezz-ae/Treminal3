...
export default function StoragePage() {
    ...
    const initialLines: DisplayLine[] = [
        { id: 'guidance-1', type: 'guidance', text: 'Welcome to Decentralized Storage.' },
        { id: 'guidance-2', type: 'guidance', text: "Describe the file you want to upload." },
    ];
    ...
    async function onSubmit(data: z.infer<typeof FormSchema>) {
        ...
        addLine({ type: 'status', text: 'Generating upload plan...' });
        ...
        try {
            ...
            addLine({ type: 'output', text: 'Error: Could not generate upload plan.' });
            setIsLoading(false);
            form.reset();
        }
    }
    ...
    <>
       <div className="sr-only">
        ...
        <p className="text-muted-foreground">
          Describe the file you want to upload, and our AI will generate a plan for you.
        </p>
      </div>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex-grow">
                                    <FormControl>
                                        <Input
                                            placeholder="e.g., 'Upload the metadata for my NFT collection, collection.json, to IPFS and pin it...'"
