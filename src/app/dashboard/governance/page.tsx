...
export default function GovernancePage() {
    ...
    const initialLines: DisplayLine[] = [
        ...
        { id: 'guidance-2', type: 'guidance', text: "Describe the governance action you want to take." },
    ];
    ...
    async function onSubmit(data: z.infer<typeof FormSchema>) {
        ...
        addLine({ type: 'status', text: 'Generating proposal...' });
        ...
        try {
            ...
            addLine({ type: 'output', text: 'Error: Could not generate proposal.' });
            setIsLoading(false);
            form.reset();
        }
    }
    ...
    <>
       <div className="sr-only">
        ...
        <p className="text-muted-foreground">
          Describe the governance proposal you want to create, and our AI will generate a plan for you.
        </p>
      </div>
