...
const FormSchema = z.object({
  description: z.string().min(10, {
    message: 'Proposal description must be at least 10 characters.',
  }),
});
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Describe the governance action you want to take.</p>
      </div>
        ...
        <Card className="max-w-2xl">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
             ...
             <Button className="mt-4">Submit Proposal</Button>
          </CardContent>
        </Card>
      )}
    </div>
