...
const initialLinesDef: DisplayLine[] = [
    ...
    { id: 'guidance-2', type: 'guidance', text: "Describe the smart contract you want to audit and I'll recommend the right tools." },
];
...
export default function AuditsPage() {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        addLine({ type: 'status', text: 'Analyzing contract for audit...' });
    ...
    <>
       <div className="sr-only">
        ...
        <p className="text-muted-foreground">
          Describe the contract you want to audit, and our AI agent will recommend the best tools for you.
        </p>
      </div>
