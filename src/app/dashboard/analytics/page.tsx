...
export default function AnalyticsPage() {
    ...
    const initialLines: DisplayLine[] = [
        { id: 'guidance-1', type: 'guidance', text: 'Welcome to On-chain Analytics.' },
        { id: 'guidance-2', type: 'guidance', text: "Describe the on-chain data you want to query." },
    ];
    ...
    async function onSubmit(data: z.infer<typeof FormSchema>) {
        ...
        addLine({ type: 'status', text: 'Generating query...' });
        ...
        try {
            ...
            addLine({ type: 'output', text: 'Error: Could not generate query.' });
            setIsLoading(false);
            form.reset();
        }
    }
    ...
    <>
       <div className="sr-only">
        ...
        <p className="text-muted-foreground">
          Describe the query you want to run, and our AI will generate a plan for you.
        </p>
      </div>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex-grow">
                                    <FormControl>
                                        <Input
                                            placeholder="e.g., 'Show me the top 10 largest swaps on Uniswap v3 on Polygon in the last 24 hours.'"
