...
export default function SmartContractsPage() {
    ...
    const initialLines: DisplayLine[] = [
        { id: 'guidance-1', type: 'guidance', text: 'Welcome to the Smart Contract Templates.' },
        { id: 'guidance-2', type: 'guidance', text: "Describe the smart contract you want to create from a template." },
    ];
    ...
    async function onSubmit(data: z.infer<typeof FormSchema>) {
        ...
        addLine({ type: 'status', text: 'Generating smart contract...' });
        ...
        try {
            ...
            addLine({ type: 'output', text: 'Error: Could not generate smart contract.' });
            setIsLoading(false);
            form.reset();
        }
    }
    ...
    <>
       <div className="sr-only">
        ...
        <p className="text-muted-foreground">
          Describe the contract you want to build, and our AI will generate a plan for you.
        </p>
      </div>
