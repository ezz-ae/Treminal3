...
const initialLinesDef: DisplayLine[] = [
    { id: 'guidance-1', type: 'guidance', text: 'Welcome to Smart Contract Templates.' },
    { id: 'guidance-2', type: 'guidance', text: "Describe the smart contract you want to create and I'll recommend the right tools." },
];
...
export default function SmartContractsPage() {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        addLine({ type: 'status', text: 'Analyzing contract requirements...' });
  ...
  return (
    <>
       <div className="sr-only">
        <h1 className="text-3xl font-bold font-headline">Smart Contract Templates</h1>
        <p className="text-muted-foreground">
          Describe the smart contract you want to generate, and our AI agent will recommend the best tools for you.
        </p>
      </div>
                         ...
                         <div className="flex gap-4">
                            ...
                            <div className="flex-1 flex gap-2 items-center">
                                ...
                                <Input
                                    ...
                                    ref={inputRef}
                                    placeholder="e.g., 'A vesting contract for team tokens that releases 25% every 6 months...'"
