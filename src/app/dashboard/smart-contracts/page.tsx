...
const FormSchema = z.object({
  description: z.string().min(10, {
    message: 'Contract description must be at least 10 characters.',
  }),
});
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Describe the smart contract you want to create from a template.</p>
      </div>
      ...
      {result && (
        <Card className="max-w-2xl">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <h4 className="font-semibold mb-2">Base Contracts</h4>
               <div className="flex flex-wrap gap-2">
             ...
             <Button className="mt-4">Build Contract</Button>
          </CardContent>
        </Card>
      )}
    </div>
