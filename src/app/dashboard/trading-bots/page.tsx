...
export default function TradingBotsPage() {
    ...
    const initialLines: DisplayLine[] = [
        ...
        { id: 'guidance-2', type: 'guidance', text: "Describe the trading strategy you want to automate and I'll recommend the right tools." },
    ];
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        addLine({ type: 'status', text: 'Analyzing trading strategy...' });
    ...
    <>
       <div className="sr-only">
        ...
        <p className="text-muted-foreground">
          Describe your trading strategy, and our AI agent will recommend the best tools to help you.
        </p>
      </div>
