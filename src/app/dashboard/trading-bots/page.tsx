...
export default function TradingBotsPage() {
    ...
    const initialLines: DisplayLine[] = [
        { id: 'guidance-1', type: 'guidance', text: 'Welcome to the Trading Bot Platform.' },
        { id: 'guidance-2', type: 'guidance', text: "Describe the trading strategy you want to automate." },
    ];
    ...
    async function onSubmit(data: z.infer<typeof FormSchema>) {
        ...
        addLine({ type: 'status', text: 'Generating trading strategy...' });
        ...
        try {
            ...
            addLine({ type: 'output', text: 'Error: Could not generate trading strategy.' });
            setIsLoading(false);
            form.reset();
        }
    }
    ...
    <>
       <div className="sr-only">
        ...
        <p className="text-muted-foreground">
          Describe the trading strategy you want to automate, and our AI will generate a plan for you.
        </p>
      </div>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex-grow">
                                    <FormControl>
                                        <Input
                                            placeholder="e.g., 'An arbitrage bot that monitors Uniswap and Sushiswap for price differences...'"
